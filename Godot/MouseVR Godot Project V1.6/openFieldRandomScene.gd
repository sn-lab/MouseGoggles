...
#eye parameters
export var inter_eye_distance = 0.012 #distance between "eyes" (in m)
export var head_radius = 0.04 #must be large enough to keep eye cameras from getting too close to walls
export var eye_pitch = 15 #degrees from the horizontal
...
export var mouse_gain = 0.05 #0.0135 for mouse, 0.05 for trackpad
