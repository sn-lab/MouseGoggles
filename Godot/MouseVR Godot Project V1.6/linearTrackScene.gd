...
#track parameters
export var exp_num = 1 #ID of mouse (determines which reward loc/track num to use)
...
export var exp_num_reward_loc := 	[-0.25, -0.25, 0.25, 0.25, 0.25] #for exp [1 2 3 4 5]
export var exp_num_track_num := 	[2, 2, 2, 2, 2] #for exp [1 2 3 4 5]
...
func _ready():	
	...
	track_reward_loc = exp_num_reward_loc[exp_num-1]
	track_num = exp_num_track_num[exp_num-1]
	if track_num==1:
