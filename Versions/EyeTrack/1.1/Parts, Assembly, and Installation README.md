...
A new version of the EyeTrack headset is currently being developed to use newer cameras and displays: [EyeTrack 1.9](https://github.com/sn-lab/MouseGoggles/tree/main/Versions/EyeTrack/1.9).
