...
// Inspector params:
uniform float fov = 164.5; //FOV (in degrees) that the circular display covers 
uniform float fovmax = 164.5; //FOV (in degrees) that the visible area of the circular display covers 
